...
We provide two types of data: the real data produced and collected in practical experiment and the virtual data generated by monte carlo potts model.
...
Unlike public data in nature science and biological image, the material microscopic image often suffer many flaws during sample preparation. As shown in Fig.1, (a) is the stack of serial sections for polycrystalline iron. (b) is one slice of metallographic image, it contains grain boundaries (straight and thick arrows), vague or missing boundaries (straight and thin arrows), noise (curved arrows) and spurious scratches (notched arrows).

The reasons of those flaws:


![](./explain_image/polycrystalline_iron.png)

<center> Fig.1. Microscopic images of polycrytalline iron </center>
